...
class IStringAutomateFactory {
public:
	IStringAutomateFactory() {
	}
	virtual std::shared_ptr<IStringAutomate> BuildAutomate(const std::string&) const  = 0;
};
...
class StringAutomateFactory: public IStringAutomateFactory {
